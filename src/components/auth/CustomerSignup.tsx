  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.profilePhoto) {
        console.log('Mengunggah foto profil...');
        try {
          profilePictureUrl = await uploadFile(
            formData.profilePhoto,
            `profile_photos/${Date.now()}_${formData.profilePhoto.name}`
          );
          console.log('Foto profil berhasil diunggah:', profilePictureUrl);
        } catch (error) {
          console.error('Error uploading profile photo:', error);
          // Tetap lanjutkan pendaftaran meskipun upload foto gagal
          toast({
            title: "Peringatan",
            description: "Gagal mengunggah foto profil, tetapi pendaftaran tetap dilanjutkan",
            variant: "destructive",
          });
        }
      }
      ...
      // Daftar pengguna dan langsung login
      ...
      if (result.requiresConfirmation) {
        ...
        toast({
          ...
          description: "Kami telah mengirimkan email konfirmasi. Silakan periksa kotak masuk Anda.",
        });
        // Tetap di halaman signup atau arahkan ke halaman konfirmasi
        return;
      }

      if (result.success) {
        console.log('Pendaftaran berhasil, mengarahkan ke dashboard...');
        // Redirect ke dashboard
        window.location.href = '/dashboard';
      }
    } catch (error: any) {
      console.error('Error detail saat pendaftaran:', {
